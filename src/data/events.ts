...
export function imagenPorSemilla(semilla: string): string {
  return `https://picsum.photos/seed/${semilla}/900/560`;
}
...
export const eventos: Evento[] = [
  {
    ...
    destacado: true,
    imagenUrl: imagenPorSemilla('atletico-norte-racing-sur'),
    sectores: [
  ...
  },
  {
    ...
    imagenUrl: imagenPorSemilla('kiroshi-tour-continental'),
    sectores: [
  ...
  },
  {
    ...
    imagenUrl: imagenPorSemilla('subsuelo-noche-09'),
    sectores: [
  ...
  },
  {
    ...
    imagenUrl: imagenPorSemilla('el-metodo-gronholm'),
    sectores: [
  ...
  },
  {
    ...
    imagenUrl: imagenPorSemilla('copa-federal-semifinal'),
    sectores: [
  ...
  },
  {
    ...
    imagenUrl: imagenPorSemilla('marea-baja-invitados'),
    sectores: [
